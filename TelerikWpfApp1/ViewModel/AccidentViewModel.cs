    ...
    public class AccidentViewModel : ViewModelBase
    {
        ...
        public void AccidentSendEmail()
        {
            try
            {
                ...
                mailMessage.Attachments.Add(new Attachment(new FileStream(@"C:\Users\user\Desktop\savefile\" + loginViewModel.PatientName + "_영수증(보험용).pdf", FileMode.Open, FileAccess.Read), loginViewModel.PatientName + "_영수증(보험용).pdf"));
                // 파일 첨부
